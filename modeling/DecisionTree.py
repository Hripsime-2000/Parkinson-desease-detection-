...
print("Model evalutaion for train data")
...
print("Model evalutaion for test data")
print("Accuracy score")
...
scores = cross_val_score(model_tree, X_train_t, y_train, cv=10, scoring=Config.scoring)
print(scores)
print(scores.mean())